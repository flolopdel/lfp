 ...
 */
angular.module('moduloDialog',['ui.bootstrap','dialogs.main','dialogs.default-translations','pascalprecht.translate'])
	.controller('dialogServiceTest',function($scope,$rootScope,$timeout,$translate,dialogs){
		...
		$scope.launch = function(which,header,msg,action,obj){
			switch(which){
				case 'error':
					dialogs.error();
					break;
				...
				case 'confirm':
					...
					break;
				case 'custom':
				//lfp/templates/liga/dialogs/addplayer.html
					var dlg = dialogs.create('/lfp/templates/liga/dialogs/addplayer.html','customDialogCtrl',{},{size:'lg',keyboard: true,backdrop: false,windowClass: 'my-class'});
					...
					break;
				case 'custom2':
					var dlg = dialogs.create('templates/liga/dialogs/addplayer.html','customDialogCtrl2',{},{size:'lg',keyboard: true,backdrop: false,windowClass: 'my-class'});
					break;
			}
		}; // end launch
